...
#'
#' \code{combine_mol2sdf} offer a way to combine multiple mol files in to
...
#'
#' \code{extract_structure} offer a way to retrieve SMILES from the sdf file.
#'
#' The function is a wrapper of the \code{convertFormatFile} function from the
#' \pkg{ChemmineOB} package. As InChI and InChIKey are not support in Windows-
#' based systems, the function will automatically determine which type of
...
#'
#' @param input The sdf file generated by \code{\link{combine_mol2sdf}}.
